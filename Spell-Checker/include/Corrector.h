...
public:
    ...
    /**
     * @brief Suggests all the possible corrections of a word where the Levenshtein distance is less than 2.
    ...
    /**
     * @brief Gets the top N suggestions from a multimap of corrections, it orders the corrections by distance.
     * if two corrections have the same distance, it orders them by frequency.
